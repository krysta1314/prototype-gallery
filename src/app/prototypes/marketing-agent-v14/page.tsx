...
const quickLinks: readonly QuickLink[] = [
  ...
  { name: "Character Swap", description: "Swap the presenter or character in any clip.", Icon: Replace, category: "Video", prompt: "Swap the presenter in this video for a creator that fits my target audience, keeping the motion, timing and voice.", thumb: "https://assets.presslogic.com/buzzvideo/public/2026-07-30/341147562885046272.png" },

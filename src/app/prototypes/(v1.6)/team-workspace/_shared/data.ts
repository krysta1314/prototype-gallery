...
export type Team = {
  ...
  topupExpires: string;
  /** 内部口径,不对 Client 端暴露（评审第 5 项:界面上已隐藏,字段保留） */
  aiTokens: number;
...
/** 成员/管理员向 Owner 发起的申请（评审第三节:撞墙时要有站内回路,不能只提示「去找管理员」） */
export type TeamRequest = {
  id: string;
  kind: "credits" | "seats" | "limit";
  fromId: string;
  fromName: string;
  /** credits = 申请的积分数,seats = 申请的席位数 */
  amount?: number;
  reason?: string;
  at: string;
...
export const TEAMS: Team[] = [
  {
    ...
    // personal: true 的含义是「个人账户上下文」,界面上不以团队形式呈现。
    id: "t-personal",
...
export const ACTIVITY_BY_TEAM: Record<string, ActivityEntry[]> = {
  ...
  "t-growth": [
    { id: "a-g1", at: "Aug 14, 2026 · 16:20", actor: "Monica Zhou", action: "set Kenji Ito's monthly limit to 5,000 credits (hard cap)", kind: "limit" },
    { id: "a-g2", at: "Aug 12, 2026 · 11:04", actor: "Alex Chen", action: "bought 50,000 top-up credits", kind: "credits" },
    { id: "a-g3", at: "Aug 09, 2026 · 09:48", actor: "System", action: "auto top-up added 50,000 credits — pool fell below 10,000", kind: "credits" },
    { id: "a-g4", at: "Aug 05, 2026 · 15:12", actor: "Monica Zhou", action: "invited priya.singh@presslogic.com as a member", kind: "member" },
    { id: "a-g5", at: "Aug 01, 2026 · 10:30", actor: "Alex Chen", action: "added 2 seats to Team Pro", kind: "billing" },
    ...
    { id: "a-g8", at: "Jul 07, 2026 · 17:02", actor: "Vera Lam", action: "removed Noah Fisher from the team", kind: "member" },
    { id: "a-g9", at: "Jun 30, 2026 · 12:41", actor: "Alex Chen", action: "added finance@presslogic.com as a billing contact", kind: "billing" },
    { id: "a-g10", at: "Jun 18, 2026 · 09:15", actor: "Alex Chen", action: "turned on auto top-up — 50,000 credits below 10,000", kind: "credits" },
    { id: "a-g11", at: "May 02, 2026 · 13:33", actor: "Monica Zhou", action: "set Daniel Park's monthly limit to 3,000 credits (soft cap)", kind: "limit" },
    { id: "a-g12", at: "Jan 12, 2026 · 10:00", actor: "Alex Chen", action: "created PressLogic Growth", kind: "team" },
  ],
  "t-beauty": [
    { id: "a-b1", at: "Aug 13, 2026 · 15:44", actor: "Mei Wong", action: "set Monica Zhou's monthly limit to 2,500 credits (hard cap)", kind: "limit" },
...
export const REQUESTS_BY_TEAM: Record<string, TeamRequest[]> = {
  "t-personal": [],
  "t-growth": [
    { id: "r-g1", kind: "credits", fromId: "u-kenji", fromName: "Kenji Ito", amount: 5_000, reason: "Reshooting the BuzzMilk cutdowns — need to finish this week.", at: "Aug 15, 2026 · 10:12", status: "pending" },
    ...
    { id: "r-g3", kind: "credits", fromId: "u-daniel", fromName: "Daniel Park", amount: 5_000, reason: "Client revisions.", at: "Jul 28, 2026 · 09:05", status: "expired" },
  ],
  "t-beauty": [],
};
